...
exports.generateCityBackground = void 0;
...
exports.generateCityBackground = (0, https_1.onCall)({
    memory: "512MiB",
    ...
    if (!city || !weatherDescription) {
        throw new https_1.HttpsError("invalid-argument", "Se requieren los parámetros 'city' y 'weatherDescription'.");
    }
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", `Error detallado en el servidor: ${error.message || error}`);
    }
});
